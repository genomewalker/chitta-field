...
// CHITTA_TEXT_FORMAT_VERSION), defaulting to the public-shipped bge-large-en-v1.5
// (1024-dim) so the CI release matches its bundled model. Personal/local builds set those
